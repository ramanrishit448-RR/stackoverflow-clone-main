...
const SERVER_ONLY_PACKAGES = [
  "bcryptjs", "mongoose", "mongodb", "express", "jsonwebtoken",
  "nodemailer", "pdfkit", "razorpay", "cors", "dotenv", "twilio",
  "aws4", "kerberos", "snappy", "@mongodb-js/zstd",
  "@aws-sdk/credential-providers", "mongodb-client-encryption",
];
